...
- [ ] Every step of Task 13 in `.procoder/plans/nexora-v1-m2.md` is done as written (deviations recorded in the plan first)
- [ ] `TestGUICoverage` passes in the dev pod (`scripts/dev-exec.sh`)
- [ ] `TestKWSmoke` passes in the dev pod (`scripts/dev-exec.sh`)
