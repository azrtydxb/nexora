...
// clientAddr is the TCP peer address of r without its port: the client key of the auth failure
// throttle. Forwarding headers are ignored because any client can set them.
