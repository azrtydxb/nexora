...
exec "$(dirname "$0")/dev-exec.sh" env \
	NEXORA_KW_DNS_ADDR=192.168.10.136:53 NEXORA_KW_DNS_ADDR_2=192.168.10.139:53 NEXORA_KW_ENGINE_ADDR="${engine_ip}:53" NEXORA_KW_EDGE_B_DNS_ADDR=192.168.10.137:53 \
